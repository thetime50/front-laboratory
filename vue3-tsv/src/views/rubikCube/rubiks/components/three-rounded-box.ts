...
// ref https://github.com/pailhead/three-rounded-box/blob/master/index.js
...
export default class RoundedBoxGeometry extends BufferGeometry{
    ...
    constructor(
        ...
        depth:number, // size of box in z axis, default 1
        radius:number, // radius of the fillet,  default 0.15
        radiusSegments:number // segments along the fillet, default 1
    ) {
