...
- Done(cell):还原路径424步,遍历状态0.046M,耗时0.492s,千次耗时10.684ms, 格数14 ew: 2, gw: 3
- Done(cell):还原路径366步,遍历状态0.192M,耗时2.072s,千次耗时10.794ms, 格数29 ew: 0.2, gw: 1.05
...
- Done(cgroup):还原路径308步,遍历状态3.520M,耗时39.188s,千次耗时11.135ms, 组数7 ew: 0.2, gw: 1.05, gs: 5
- Done(cgroup):还原路径278步,遍历状态3.963M,耗时34.315s,千次耗时8.659ms, 组数6 ew: 0.2, gw: 1.05, gs: 6
- Done(cgroup):还原路径274步,遍历状态4.368M,耗时47.277s,千次耗时10.825ms, 组数5 ew: 0.2, gw: 1.05, gs: 7

... 31,20,27
- Done(开窗):还原路径290步,遍历状态1.655M,耗时15.752s,千次耗时9.517ms, 窗数10 wiW: 3, wiH: 1, ww: 4
- Done(cell):还原路径360步,遍历状态1.564M,耗时15.770s,千次耗时10.081ms, 格数28 ew: 0.2, gw: 1.05
- Done(cgroup):还原路径252步,遍历状态0.094M,耗时0.815s,千次耗时8.648ms, 组数12 ew: 0.2, gw: 1.05, gs: 3
- Done(cgroup):还原路径298步,遍历状态0.862M,耗时8.705s,千次耗时10.098ms, 组数10 ew: 0.2, gw: 1.05, gs: 4
- Done(cgroup):还原路径228步,遍历状态0.358M,耗时3.342s,千次耗时9.335ms, 组数8 ew: 0.2, gw: 1.05, gs: 5
- Done(cgroup):还原路径242步,遍历状态0.164M,耗时1.435s,千次耗时8.762ms, 组数5 ew: 0.2, gw: 1.05, gs: 6
- Done(cgroup):还原路径252步,遍历状态0.154M,耗时1.349s,千次耗时8.758ms, 组数5 ew: 0.2, gw: 1.05, gs: 7
